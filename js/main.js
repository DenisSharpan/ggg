...
function popupOpen(pl, v) {
	...
	if ($('.popup-' + pl).find('.slick-slider').length > 2) {
...
$(document).ready(function() {
	$('.subtitle__title').click(function(event) {
		if($('.about-us__subtitle').hasClass('one')){
			$('.subtitle__title').not($(this)).removeClass('active');
			$('.subtitle__text').not($(this).next()).slideUp(300);
		}
...
$(document).ready(function() {
	$('.about-us-counter__number ,.number-speaks__number').each(function () {
